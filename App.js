...
const ArtistListTabContent = ({ artists, columnHeaders, isLoading, error, displayColumnRange, tabName }) => {
  ...
  // const [generatedDescription, setGeneratedDescription] = useState(''); // Estado para la descripción generada por LLM (REMOVED)
  // const [isGeneratingDescription, setIsGeneratingDescription] = useState(false); // Estado para el indicador de carga de LLM (REMOVED)
  ...
  // Función para generar descripción del artista usando Gemini API (REMOVED)
                          ...
                          {colIndex === 0 ? ( // Asumiendo que la primera columna mostrada es el nombre del artista (Columna B)
                            <span
                              ...
                              onClick={() => {
                                ...
                                // setGeneratedDescription(''); // Clear previous generated description (REMOVED)
                              }}
                            >
                              {artist.data[header]}
                            </span>
        ...
        <div className="fixed inset-0 bg-gray-900 bg-opacity-70 flex items-center justify-center z-50">
          <div className="bg-gray-800 p-6 rounded-xl shadow-xl max-w-md w-full mx-4 relative">
            ...
            <div className="flex justify-center mt-6">
              {/* REMOVED: Botón Generar Descripción */}
              <button
            ...
            {/* REMOVED: Área de Descripción Generada */}
...
const App = () => {
  ...
  // New states for random artist description (REMOVED)
  ...
  const pickRandomArtist = () => {
    ...
    // setRandomArtistGeneratedDescription(''); // Clear description when new random artist is picked (REMOVED)
  };

  // Función para generar descripción del artista aleatorio usando Gemini API (REMOVED)
